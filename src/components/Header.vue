  ...
  <header class="bg-white">
    <nav class="mx-auto flex items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <PopoverGroup class="hidden lg:flex lg:gap-x-12">
        ...
        <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Прогресс</a>
        <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Питание</a>
        <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Друзья</a>
        <a href="#" class="text-sm font-semibold leading-6 text-gray-900">Профиль</a>
      </PopoverGroup>
