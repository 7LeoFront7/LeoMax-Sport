...
import { dataOfCardioPrograms } from '../../dataOfProgramsCardio'
...
function openCardioModal(e) {
  currentProgramId.value = e.target.id
}

function programConfirm() {
  const dayCardioTraningEnd = {
    day: dayToday,
    month: monthToday,
    year: yearToday,
    class: 'Кардио'
  }
  arrCalendarTraning.value.push(dayCardioTraningEnd)
...
<template>
    ...
    <div v-for="programItem in dataOfCardioPrograms" class="card bg-base-100 w-full mb-6 shadow-xl">
      <div class="card-body p-4">
        ...
        <div class="card-actions justify-end">
          <button @click="openCardioModal" onclick="my_modal_3.showModal()" :id="programItem.id"
  ...
  <dialog id="my_modal_3" class="modal">
    <div class="modal-box h-5/6 pt-10">
      ...
      <div class="mb-4" v-for="prog in dataOfCardioPrograms">
